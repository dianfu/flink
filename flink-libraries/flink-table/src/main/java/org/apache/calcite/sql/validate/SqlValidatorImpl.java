...
/*
 * THIS FILE HAS BEEN COPIED FROM THE APACHE CALCITE PROJECT UNTIL CALCITE-1909 and CALCITE-1943 IS FIXED.
 */
...
public class SqlValidatorImpl implements SqlValidatorWithHints {
  ...
  protected RelDataType createTargetRowType(
    ...
    if (append) {
      for (RelDataTypeField targetField : targetFields) {
        types.add(
            Pair.of(
                SqlUtil.deriveAliasFromOrdinal(types.size()),
                targetField.getType()));
      }
    }
  ...
  @Override public void validateMatchRecognize(SqlCall call) {
    ...
    final RelDataTypeFactory.FieldInfoBuilder typeBuilder = typeFactory.builder();
