...
import org.apache.flink.ml.table.common.ParameterMap
...
object ChainedTransformer{
  ...
  implicit def chainedTransformOperation[
      ...
      T,
      O](implicit
      transformOpLeft: TransformDataSetOperation[L],
      transformOpRight: TransformDataSetOperation[R])
    : TransformDataSetOperation[ChainedTransformer[L,R]] = {

    new TransformDataSetOperation[ChainedTransformer[L, R]] {
  ...
  implicit def chainedFitOperation[L <: Transformer[L], R <: Transformer[R], I, T](implicit
      leftFitOperation: FitOperation[L],
      leftTransformOperation: TransformDataSetOperation[L],
      rightFitOperation: FitOperation[R]): FitOperation[ChainedTransformer[L, R]] = {
    new FitOperation[ChainedTransformer[L, R]] {
      override def fit(
