...
trait Transformer[Self <: Transformer[Self]]
  ...
  def transform(
      ...
      (implicit transformOperation: TransformDataSetOperation[Self])
    : Table = {
...
//    : TransformDataSetOperation[Instance] = {
//    new TransformDataSetOperation[Instance] {
...
/** Type class for a transform operation of [[Transformer]]. This works on [[DataSet]] of elements.
  ...
  *                  defined
  */
trait TransformDataSetOperation[Instance] extends Serializable{
...
trait TransformOperation[Instance, Model, Input, Output] extends Serializable{
  ...
  /** Retrieves the model of the [[Transformer]] for which this operation has been defined.
    ...
    * @return
    */
  def getModel(instance: Instance, transformParameters: ParameterMap): Table
