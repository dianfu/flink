...
trait Predictor[Self] extends Estimator[Self] with WithParameters {
  ...
  def predict(
      ...
      predictor: PredictDataSetOperation[Self]): Table = {
  ...
  def evaluate[Testing, PredictionValue](
      ...
      evaluator: EvaluateDataSetOperation[Self])
    : Table = {
...
object Predictor {
  ...
  implicit def defaultPredictDataSetOperation[
    ...
    : PredictDataSetOperation[Instance] = {
    new PredictDataSetOperation[Instance] {
...
//      testingTypeInformation: TypeInformation[Testing],
//      predictionValueTypeInformation: TypeInformation[PredictionValue])
//    : EvaluateDataSetOperation[Instance] = {
//    new EvaluateDataSetOperation[Instance] {
...
//          case (element, model) => {
//            val t = element.asInstanceOf[Tuple2]
//            (t._2, predictOperation.predict(t._1.asInstanceOf[Testing], model))
//          }
//        }
//      }
//    }
...
/** Type class for the predict operation of [[Predictor]]. This predict operation works on DataSets.
  ...
  */
trait PredictDataSetOperation[Self] extends Serializable{
...
/** Type class for the evaluate operation of [[Predictor]]. This evaluate operation works on
  ...
  *
  */
trait EvaluateDataSetOperation[Instance] extends Serializable{
  def evaluateDataSet(
      instance: Instance,
      evaluateParameters: ParameterMap,
      testing: Table): Table
