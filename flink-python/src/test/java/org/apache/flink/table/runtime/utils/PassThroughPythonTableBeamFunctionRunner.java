...
/**
 * A {@link TableBeamPythonFunctionRunner} that emit each input element in inner join and emit null
 * in left join when certain test conditions are met.
 */
public class PassThroughPythonTableBeamFunctionRunner extends TableBeamPythonFunctionRunner {

    private int num = 0;

    private final List<byte[]> buffer;

    public PassThroughPythonTableBeamFunctionRunner(
            String taskName,
