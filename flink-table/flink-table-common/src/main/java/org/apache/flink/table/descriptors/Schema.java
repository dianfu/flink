...
public class Schema implements Descriptor {
	 ...
	 * Should be removed once SchemaValidator is ported to flink-table-common.
	 */
	@Deprecated
	 ...
	 */
	public Schema rowtime(Map<String, String> rowtimeProperties) {
		if (lastField == null) {
			throw new ValidationException("No field defined previously. Use field() before.");
		}
		tableSchema.get(lastField).putAll(rowtimeProperties);
		lastField = null;
		return this;
	}
